export const projectInfo = [
  {
    ...
    integration), and SEO-friendly image/category pages.
    Designed and built an admin dashboard to manage users, images, categories, coupons, and other platform features.
    Enhanced the search system with category filters, improving accuracy and user experience.`,
    image: "/vecteno.png",
    link: "https://vectenoindia.com/",
    stack: [
      "Next.js",
      "Tailwind CSS",
      "MongoDB",
  ...
  },
  {
    ...
    Implemented click-tracking and analytics (total clicks, geolocation, and device type) to provide
    actionable insights.`,
    image: "/urlShortener.png",
    link: "https://url-shortener-nine-dun.vercel.app/",
